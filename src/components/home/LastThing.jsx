...
const LastThing = () => {
  return (
    ...
    >
      <h1 className=" flex justify-center text-3xl sm:text-4xl xl:text-5xl font-semibold">
        <div className=" flex lg:flex-col lg:justify-start items-start gap-2">
          <p className=" text-white">One Last </p>
          <p className=" text-primary-blue">Last Thing</p>
        </div>
      </h1>
      <p className=" lg:col-span-2 text-stone-300 text-base xl:text-lg text-center lg:text-left">
