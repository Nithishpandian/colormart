...
const HeroSection = () => {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center gap-6 mx-4 sm:mx-12 md:mx-14 lg:mx-16 xl:mx-24 my-10 py-32 px-5 sm:px-6 md:px-8 lg:px-10 xl:px-16 bg-primary-blue rounded-2xl"
    >
